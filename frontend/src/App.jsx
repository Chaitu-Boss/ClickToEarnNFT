...
//   const milestones = [500, 1000, 5000];
  // const milestoneURIs = {
  //   500: import.meta.env.MILESTONE_500,
  //   1000: import.meta.env.MILESTONE_1000,
  //   5000: import.meta.env.MILESTONE_5000,
  // }
//   useEffect(() => {
//     if (clicks > 0 && milestones.includes(clicks)) {
//       mintNFT(clicks);
//     }
//   }, [clicks]);
...
//   const mintNFT = async (clicks) => {
//     try {
//       const provider = new ethers.BrowserProvider(window.ethereum);
//       const signer = await provider.getSigner();
//       const contract = new ethers.Contract(CONTRACT_ADDRESS, contractABI, signer);

//       const tx = await contract.mintNFT(account, milestoneURIs[clicks]);
//       await tx.wait();
//       alert("NFT Minted!");
//     } catch (error) {
...
//                 <p className="text-lg font-semibold mb-2">Clicks: <span className="text-yellow-400">{clicks}</span></p>
//                 <button
